...
- **Global scope**: `/home/whitebehemoth/Dev/Projects/monsgeek-firmware-driver/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/whitebehemoth/Dev/Projects/monsgeek-firmware-driver/.claude/notes/`)
...
2. Glob `/home/whitebehemoth/Dev/Projects/monsgeek-firmware-driver/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/whitebehemoth/Dev/Projects/monsgeek-firmware-driver/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/whitebehemoth/Dev/Projects/monsgeek-firmware-driver/.claude/notes/` — works in any directory
