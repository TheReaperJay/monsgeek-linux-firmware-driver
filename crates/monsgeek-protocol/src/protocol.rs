...
pub struct CommandTable {
    ...
    // YiChip SIMPLE commands (None on RY5088)
...
pub static RY5088_COMMANDS: CommandTable = CommandTable {
    ...
    get_debounce: 0x86,
    get_keymatrix: 0x8A,
    set_keymatrix_simple: None,
    get_keymatrix_simple: None,
    set_fn_simple: None,
    get_fn_simple: None,
...
pub static YICHIP_COMMANDS: CommandTable = CommandTable {
    ...
    get_debounce: 0x91,
    get_keymatrix: 0x89,
    set_keymatrix_simple: Some(0x13),
    get_keymatrix_simple: Some(0x93),
    set_fn_simple: Some(0x15),
    get_fn_simple: Some(0x95),
    set_report: None,
    set_kboption: None,
    set_sleeptime: None,
    get_report: None,
