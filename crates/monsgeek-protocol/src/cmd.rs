...
pub const SET_KEYMATRIX_SIMPLE: u8 = 0x13;
pub const SET_FN_SIMPLE: u8 = 0x15;
...
pub const GET_KEYMATRIX_SIMPLE: u8 = 0x93;
pub const GET_FN_SIMPLE: u8 = 0x95;
...
pub fn name(cmd: u8) -> &'static str {
    match cmd {
        ...
        SET_KEYMATRIX_SIMPLE => "SET_KEYMATRIX_SIMPLE",
        SET_FN_SIMPLE => "SET_FN_SIMPLE",
        SET_FN => "SET_FN",
        ...
        GET_KEYMATRIX_SIMPLE => "GET_KEYMATRIX_SIMPLE",
        GET_FN_SIMPLE => "GET_FN_SIMPLE",
